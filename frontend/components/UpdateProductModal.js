...
const UpdateProductModal = ({ isOpen, onClose, product, onUpdateSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const finalQuantityChange =
      action === "sale" ? -quantityChange : quantityChange;

    try {
      // Backend expects { action, amount } where amount is a positive number
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="modal-form-group">
            <label>SKU</label>
            <input type="text" value={skuId} readOnly />
          </div>
          <div className="modal-form-group">
            <label>Current Stock</label>
            <input type="number" value={currentStock} readOnly />
          </div>
          <div className="modal-form-group">
