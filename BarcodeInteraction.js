// Inside src/components/BarcodeInteraction.js (or relevant section of ProductsPage.js)
...
const BarcodeInteraction = () => {
    ...
    const handleGetProductByBarcode = async () => {
        ...
        try {
            ...
            alert(`Product found: ${product.name} (Current Stock: ${product.quantity})`);
        } catch (err) {
    ...
    const handleUpdateProductByBarcode = async () => {
        ...
        try {
            ...
            await fetchData(`/api/products/scan/${barcode}`, 'PUT', {
                ...
                <div className="product-details">
                    ...
                    <div className="input-group">
                        <input
                            ...
                            disabled={loading}
                        />
                        <select value={updateAction} onChange={(e) => setUpdateAction(e.target.value)} disabled={loading}>
